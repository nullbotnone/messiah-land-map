...
export const jerusalemSites: JerusalemSite[] = [
  { id: 'temple', name: '圣殿与内院', en: 'Sanctuary and inner courts', x: 0, z: 0, onPlatform: true,
    description: '殿宇朝东，宽 100 肘、高 100 肘（约 50 米）；内院 187 × 135 肘，向东连着 135 肘见方的妇女院，中间是尼迦挪门。祭坛 32 肘见方，在殿前偏南。外邦人院与内院之间有 3 肘高的「梭雷格」石栏，栏上的希腊文警告碑已出土两块。尺寸依《米示拿·中门》与约瑟夫斯，立面细节为示意。',
    enDescription: 'The sanctuary faces east, 100 cubits wide and 100 high (about 50 m). The inner court measures 187 × 135 cubits and opens east through the Nicanor Gate into the 135-cubit square Court of the Women. The altar is 32 cubits square, south of the sanctuary axis. A 3-cubit balustrade, the soreg, separated the outer court from the inner precinct; two of its Greek warning inscriptions have been found. Dimensions follow Mishnah Middot and Josephus; facades are schematic.',
    certainty: '文献尺寸 · 立面示意', enCertainty: 'Literary dimensions · schematic elevations', reference: 'Mark 11:15–19 · John 2:13–22 · Acts 21:28', sources: ['middot', 'josephus', 'temple'] },
  { id: 'royal-stoa', name: '皇家柱廊与南门阶', en: 'Royal Stoa and southern steps', x: 60, z: 236, onPlatform: true,
    ...
    certainty: '考古遗存与文献 · 上层复原', enCertainty: 'Excavated below, reconstructed above', reference: 'Luke 2:46 · Acts 2:41 · Mark 13:1', sources: ['herodian', 'josephus', 'museum'] },
  { id: 'robinson', name: '罗宾逊拱门与提罗泊谷大街', en: 'Robinson’s Arch and the Tyropoeon street', x: -105, z: 236,
    description: '西南角外伸出一道跨度约 15 米、宽约 15 米的巨拱，托着一段折向南的阶梯，从谷底街道升入皇家柱廊；拱脚石至今仍嵌在墙上。拱下是铺石大街与一排店铺。角楼上方是「吹号处」，刻字的栏石已出土。',
    enDescription: 'A monumental arch about 15 m across and 15 m wide carried a staircase from the valley street up into the Royal Stoa; its springing stones still project from the wall. A paved street and a row of shops ran beneath it. The parapet above the corner was the trumpeting place, and its inscribed stone has been recovered.',
    certainty: '考古遗存 · 阶梯复原', enCertainty: 'Excavated remains · reconstructed stair', reference: 'Luke 19:45–46', sources: ['herodian', 'road', 'josephus'] },
  { id: 'wilson', name: '威尔逊拱门与西斯图斯', en: 'Wilson’s Arch and the Xystus', x: -170, z: 96,
    description: '西墙中段的拱桥，把圣殿平台与上城连起来，拱顶距基岩约 22 米。桥西端是称为「西斯图斯」的广场和议会厅；约瑟夫斯说第一道城墙的北段正是从希匹库塔经西斯图斯接到圣殿西廊。桥址确定，桥面建筑为示意。',
    enDescription: 'A bridge in the middle of the western wall linking the esplanade to the Upper City, its crown some 22 m above bedrock. At its western end lay the Xystus plaza and the council chamber; Josephus traces the first wall’s northern arm from the Hippicus tower past the Xystus to the temple’s western portico. The site is certain; the structures on top are schematic.',
    certainty: '遗存定位 · 上部示意', enCertainty: 'Located by remains · superstructure schematic', reference: 'Josephus · Jewish War V.4.2', sources: ['josephus', 'herodian'] },
...
const KIDRON: number[][] = [[395, -700, 112], [338, -300, 96], [300, -40, 88], [235, 300, 72], [150, 560, 50], [85, 900, 44], [-10, 1230, 42], [-60, 1420, 38], [180, 1520, 20]];
const TYROPOEON: number[][] = [[-320, -560, 150], [-235, -300, 140], [-165, -60, 124], [-124, 180, 112], [-95, 400, 94], [-62, 650, 66], [-30, 860, 40], [-18, 1040, 38]];
const HINNOM: number[][] = [[-790, -80, 176], [-858, 300, 150], [-880, 620, 126], [-836, 880, 100], [-700, 1030, 76], [-495, 1150, 56], [-300, 1165, 44], [-140, 1270, 40], [-40, 1400, 40]];
